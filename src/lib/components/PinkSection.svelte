<section class="bg-primary-300/30 py-24 md:py-32">
  <div class="container mx-auto px-6 md:px-12">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
      ...
      <!-- Image -->
      <div class="relative">
        <div class="aspect-video bg-gray-200 overflow-hidden shadow-xl">
          <img 
            src="/generated/image-three-business-professionals-collaborati-1766108744188-0.webp" 
            alt="Silima Group team collaboration"
            class="w-full h-full object-cover"
          />
        </div>
        <p class="text-[10px] text-gray-700 mt-2 text-right">
          The Silima Group team bringing operational expertise to every partnership.
        </p>
      </div>
    </div>
  </div>
